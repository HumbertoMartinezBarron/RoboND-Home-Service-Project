...
int main(int argc, char** argv){
  ...
  if(ac.getState() == actionlib::SimpleClientGoalState::SUCCEEDED) {
    ...
    ROS_INFO("The base failed to move to the pickup point for some reason...");
  
  ROS_INFO("Waiting five seconds to pick up the stuff!");
  ...
  if(ac.getState() == actionlib::SimpleClientGoalState::SUCCEEDED)
  	...
  	ROS_INFO("The base failed to move to the dropoff point for some reason...");
